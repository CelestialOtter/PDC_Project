...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Specifications Grammar</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ecoreModelProject.impl.SpecificationsGrammarImpl#getSpecifications <em>Specifications</em>}</li>
 *   <li>{@link ecoreModelProject.impl.SpecificationsGrammarImpl#getOperations <em>Operations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecificationsGrammarImpl extends MinimalEObjectImpl.Container implements SpecificationsGrammar {
	/**
	 ...
	 * @generated
	 */
	protected SpecificationsGrammarImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcoreModelProjectPackage.Literals.SPECIFICATIONS_GRAMMAR;
	}
	...
	public EList<Specification> getSpecifications() {
		if (specifications == null) {
			specifications = new EObjectContainmentEList<Specification>(Specification.class, this,
					EcoreModelProjectPackage.SPECIFICATIONS_GRAMMAR__SPECIFICATIONS);
		}
	...
	public EList<BinaryOp> getOperations() {
		if (operations == null) {
			operations = new EObjectContainmentEList<BinaryOp>(BinaryOp.class, this,
					EcoreModelProjectPackage.SPECIFICATIONS_GRAMMAR__OPERATIONS);
		}
		return operations;
	}
